...
Timing: appears on the first word of the closing line, holds to the last frame (~3–5 s). If the video ends on B-roll, that's the best place for it (no face on screen).
