# Content types — the recipe per video type
...
## Just-listed / just-sold (short)
- Hook: "Just listed in [neighbourhood]" + the standout feature.
- Fast cuts of the best shots + an optional price / beds-baths card + CTA.

## Neighbourhood / relocation (e.g. "Moving to [city]")
- Hook: "Thinking of moving to [city]? Here's what you need to know."
- Real-place b-roll (own footage / Wikimedia / Street View), pros & cons, lifestyle, CTA.

## Tips / educational (short or long)
- Hook: a bold claim or "3 things…".
- Numbered structure (short: karaoke carries it; long: an emphasis pop-up per point), punch-ins, CTA.

## Testimonial / client win
- Hook: the result ("We got them $40k under asking").
- Let the client / story carry it; subtle b-roll; warm bed; CTA.

## Multi-speaker (a guest, a lender, a client interview) — Riverside's home turf
- `apply_smart_layout(style:"Smart")` handles active-speaker switching with grid shots; `apply_smart_mutes` kills the non-speaker's mic bleed. Lower third for each person on first appearance. Everything else as long-form.

## Always
Open on the hook · clean audio (Magic Audio) · end on a complete thought + the agent's CTA · on-brand · the 80% always-done core (the agent finishes the 20% by hand).
