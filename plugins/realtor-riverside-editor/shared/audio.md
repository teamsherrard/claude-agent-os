...
| Phone audio, laptop mic, an echoey room | **0.85** |
| A genuinely bad room | 1.0 |
| A pro mic in a treated space, and full strength thins the voice | 0.45, or off — logged |
...
5. **Levels against music** — the bed sits at -18 dB under the voice on a reel, -22 dB on a long-form (`music.md`). If the agent says the music fights the voice, lower the bed, never raise the voice.
...
You cannot hear playback. After any audio change, the hand-back always includes: *"Does the audio feel right to your ear? If it sounds thin, I'll ease it back; if there's still echo, I'll push it."* Save their answer to the config (and push the Brain) so the next video starts at their level.
