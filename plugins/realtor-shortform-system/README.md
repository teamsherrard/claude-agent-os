...
| `shortform-batch-publish` | The hands-off publishing department — point at a Drive folder of finished content, and it reads each piece, writes the per-platform packages, and schedules a whole month into the Metricool queue at best times. One review, then live. |
