...
script as a clean Google Doc named **Script** inside it. Keep it readable for a teleprompter: clear
section labels, generous spacing, spoken words prominent, cues set apart.
