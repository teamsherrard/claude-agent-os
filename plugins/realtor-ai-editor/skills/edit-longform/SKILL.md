...
5. **Studio Sound — ALWAYS, automatic, every video** (agents record on phones). ~90% (100% for echoey rooms); it renders on playback, so verify the flag, not the scrub preview.
