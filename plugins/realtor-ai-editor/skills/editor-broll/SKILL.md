...
- **Placement & amount (hard cap)** — 2.5–5s each, on the exact words; **full-cover, never a partial clip floating over the face**; never cover the hook, the face, or the CTA. **A short-form reel gets a MAXIMUM of 3 cutaways TOTAL — never more** (over-b-roll drains credits, clutters, and buries the agent's face); long-form gets more but curated, never wall-to-wall. **If the agent wants more than the cap, they add it by hand in Descript (free). About to exceed 3 on a reel? STOP and cut the weakest instead of adding.**
