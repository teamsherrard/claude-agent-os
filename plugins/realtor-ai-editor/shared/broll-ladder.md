...
5. **Placement & amount (hard caps)** — 2.5–5s each, on the exact words; **full-cover cutaways — NEVER a partial clip floating over the speaker's face**; never over the hook or CTA. **Amount is CAPPED: a short-form reel gets 3–5 clips TOTAL — never more (over-b-roll drains credits, clutters, and buries the agent's face). Long-form gets more, but curated, not constant — a cutaway only where it earns its place, never wall-to-wall b-roll.** If you're about to exceed the short-form cap of 5, STOP and cut the weakest, don't add.
